...
def load_path(path):
    ...
    for folder in os.listdir(path):
        folder = os.path.join(path, folder)  # Use os.path.join for cross-platform compatibility
                ...
                for id_p in os.listdir(path_p):
                    ...
                    for lab in os.listdir(path_id):
                        ...
                        for img in os.listdir(path_l):
                            ...
                            dataset.append({
                                'label': label,  # Change label to be 'fractured' or 'normal'
                                'image_path': img_path
                            })
    return dataset
...
outputs = tf.keras.layers.Dense(len(np.unique(labels)), activation='softmax')(x)  # Update output layer
...
true_classes = test_images.classes  # Get true labels
